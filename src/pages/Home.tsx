      ...
      <section className="py-32 px-6 w-full max-w-[1920px] mx-auto">
        ...
        <div className="space-y-32">
          <FeatureRow
            ...
            title="Native & Visual Project Navigation"
            desc="Stop memorizing file paths. Toggle the powerful Neo-Tree git-aware explorer for complex tasks, or use native OS file dialogs (Ctrl+O/Ctrl+N) to open projects and save files—best of both worlds."
